...
int main()
{
   ...
   setsockopt(sock, /*IPPROTO_IP, IP_MULTICAST_IF*/ SOL_SOCKET, SO_REUSEADDR, &iaddr,
   ...
   saddr.sin_addr.s_addr = inet_addr("192.168.0.156");
   saddr.sin_port = htons(4102);

   // put some data in buffer
   strcpy(buffer, "Hello David\n");
...
int addrlen;
	  ...
	  if ((nbytes=recvfrom(sock,buffer,1024,0,
